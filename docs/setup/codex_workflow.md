...
4. Record each meaningful run with command, hardware, wallclock target, `val_bpb`, and artifact size.
5. Run submission safety checks before proposing anything under `records/`.
