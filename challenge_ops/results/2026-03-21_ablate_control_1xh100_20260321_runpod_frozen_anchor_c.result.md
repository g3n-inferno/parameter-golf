...
- `run_id`: ablate_control_1xh100_20260321_runpod_frozen_anchor_c
- `experiment_id`: control_runpod_1xh100_20260321_frozen_anchor_confirm2
- `date`: 2026-03-21
- `branch`: detached
- `commit_sha`: c59338a1920870c1648faf90c29416f15ebf63bf
- `log_path`: C:\Users\g3n_i\Desktop\0. Coding\Projects\parameter-golf\logs\experiments\next_1xh100_workstream\control\20260321_004653_ablate_control_1xh100_20260321_runpod_frozen_anchor_c\run.log
...
- `exact_command`: RUN_ID=ablate_control_1xh100_20260321_runpod_frozen_anchor_c TARGET_GPU_LABEL=h100_sxm_reuse474_frozen bash scripts/experiments/run_1xh100_ablation.sh control

## Confirmed Metrics

- `final_val_loss`: 2.25364497
- `final_val_bpb`: 1.33473550
- `final_metric_source`: final_int8_zlib_roundtrip_exact
- `final_eval_time_ms`: 11085
- `stop_reason`: wallclock_cap
- `stop_step`: 1293
- `stop_train_time_ms`: 600281
- `peak_memory_allocated_mib`: 10239
- `peak_memory_reserved_mib`: 10554
- `model_int8_zlib_bytes`: 13710371
- `code_bytes`: 61795
- `total_submission_size_int8_zlib_bytes`: 13772166

## Comparison

- `comparison.label`: runpod_1xh100_control_anchor
- `comparison.delta_val_loss`: 0.02222082
- `comparison.delta_val_bpb`: 0.01316043
- `comparison.delta_bytes_total`: -232398
- `comparison.delta_stop_step`: -213
...
- Third provenance-hardened same-pod control rerun on reused stable-profile pod 474jlphqpo5n8x; widened again after the near-recovery second run.

## Artifact Cap Check

- `artifact_cap_bytes`: 16000000
- `artifact_cap_ok`: True
- `counted_total_bytes`: 13772166
