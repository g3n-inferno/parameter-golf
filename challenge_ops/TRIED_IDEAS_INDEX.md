...
| `LR Warmdown` | `longer_warmdown_schedule` | `experiments/ledger.csv#run_id=ablate_lr_warmdown_1xh100_1024` | `delta_val_bpb=-0.00411918` vs local baseline | `variant / already-tried / positive / non-record @ 1xH100-surrogate` | Strongest local positive signal in current ledger. |
