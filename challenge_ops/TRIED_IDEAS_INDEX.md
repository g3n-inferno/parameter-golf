...
| `Control 1xH100` | `runpod_1xh100_control_anchor` | `experiments/ledger.csv#run_id=ablate_control_1xh100_20260320_runpod_retry2` | `mixed 1xH100-surrogate evidence: Runpod control anchor val_bpb=1.32157507 vs clean Runpod retry val_bpb=1.33518228` | `variant / already-tried / inconclusive / non-record @ 1xH100-surrogate` | Fresh single-pod Runpod retry on `xgi77lp1vapny8` was materially worse than the current Runpod `1xH100` control anchor; treat it as a workflow-variance anchor, not a promotion signal. |
